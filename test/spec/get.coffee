...
do ->
    ...
    describe "alchemy.get", ->
        ...
        describe "nodes", ->
            it "should return array of all nodes when passed no arguments", ->
                containedNodes = _.map alchemy.get.nodes(), (n)-> n
        ...
        describe "edges", ->
            it "should return array of all edges when passed no arguments", ->
                containedEdges = _.map alchemy.get.edges(), (e)-> e
        ...
        describe "state", ->
            it "should return array subset of node(s) of passed state", ->
                containedNodes = _.map alchemy.get.nodes(0, 1).state("active"), (n)-> n
                expect(containedNodes).to.deep.include.members([testNode2]);
            it "should return array subset of edge(s) of passed state", ->
                containedEdges = _.map alchemy.get.edges("1-0", "2-0").state("active"), (e)-> e
